...
$del = mysqli_query($conn, "DELETE FROM  schedule_wend WHERE sem='$sem'") or die(mysqli_error($conn));

$del2 = mysqli_query($conn, "DELETE FROM  checker_wend WHERE sem='$sem'") or die(mysqli_error($conn));
