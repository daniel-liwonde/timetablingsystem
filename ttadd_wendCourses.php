...
if (isset($_GET['action']) == "delete") {
    $del = mysqli_query($conn, "DELETE FROM  wendcourses WHERE sem='$sem'") or die(mysqli_error($conn));
}
?>
                    ...
                    <div class="span12" style="border:1px; margin-top:20px; ">
                        ...
                        <div class="hero-unit-3" style="margin-top:15px;min-height:900px; width:103%">
                            <div class="alert alert-info">
                                ...
                                <strong><i class="fas fa-list-check"></i>&nbsp;Add courses to weekend Timetable</strong>
                            </div>
        ...
        INNER JOIN teacher ON subject.teacher_id =teacher.teacher_id";
                                        ...
                                        while ($rows = mysqli_fetch_assoc($find)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="#" onclick='$("#msg").html("Please wait..."),$.getJSON("ttdo_wend.php",
                                                    {
                            ...
                            <div class="hero-unit-3"
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="fas fa-circle-plus"></i>&nbsp;Added Courses | <a
                                            onclick="return confirm('This action will remove all added weekend course. Do you want to proceed?')"
                                ...
                                <table class="table table-stripped table-hover table-bordered examples"
                                    id="mywendTable">
